...
if (isset($_POST['ahkmo'])) {
	$statsahkmo = mysql_query("SELECT * FROM `info` WHERE `newid` = 3");
	$statsahkmo = mysql_fetch_array($statsahkmo);
	$statsahkmo['id'] ++;
	$numberid = $statsahkmo['id'];
	mysql_query("UPDATE `info` SET `id` = '$numberid' WHERE `newid` = 3");
	header('location: https://github.com/pumbasl/ahk/raw/master/AHK%20by%20Wiberg.exe');
}
...
<head>
	<meta charset="utf-8">
	<title>Загрузка | AHK by Wiberg</title>
...
<div id="header">
	...
	<div id="sidebar" class="visible">
		...
		<ul>
			...
			<li><a href="download.php" class="selected">Скачивание</a></li>
	...
	<div id="supportcontent">
		<H4><p><b>Добро пожаловать на страницу загрузок.<br>
		Здесь вы сможете скачать наши скрипты для удобной игры на Advance RolePlay :)</b></p></H4><br>

		<form method="POST" action="download.php">
			<p><button name="ahkmo" class="btn btn-ahkmo waves-effect waves-light indexbutton">Скачать AHK for Ministy Of Defense</button></p>
		</form>
	</div>
